...
@WebServlet("/hb/admin_student_detailinfo.hb")
public class StudentDetailInfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		req.getRequestDispatcher("/admin_studetailinfo.jsp").forward(req, resp);
