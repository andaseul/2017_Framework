...
@WebServlet("/hb/consulting_data.hb")
public class ConsultingBBSWriteData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			result = dao.insert_consulting_data(title, username, memo, file, file_size);
