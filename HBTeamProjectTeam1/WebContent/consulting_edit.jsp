...
<html>
	...
	<body>
		...
		<div id="content">
			<div id="con-title">
				<h3>취업 정보 > 컨설팅 게시판 > 게시물 수정</h3>
			</div>
			<form name="writeform" method="post" action="consulting_update.hb" enctype="multipart/form-data">
				<input type="text" name="idx" value="<%=bean.getIdx() %>" hidden="hidden"/>
				<input type="text" name="username" value="<%=bean.getUsername() %>" hidden="hidden"/>
